    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_permisos', models.IntegerField(choices=[(0, 'Administrador'), (1, 'Gestión de proveedores-productos'), (2, 'Gestión de movimientos')], default=0)),
                ('groups', models.ManyToManyField(related_name='custom_users', to='auth.Group')),
                ('rol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='plataformaApp.roles')),
